...
The seed can be, for example, generated using SHA256 algorithm on some random input generated by cryptographically secure pseudo-random generator, such as [os.urandom() in Python](https://client-lib.docs.iota.org/libraries/python/examples.html#generating-seed-and-addresses) or [crypto.randomBytes() in Nodejs](https://client-lib.docs.iota.org/libraries/nodejs/examples.html#generating-seed-and-addresses).
